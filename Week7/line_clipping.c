...
int main(int argc, char **argv) 
{
    ...
    else
    {
        ...
        if(code2)
        {
            ...
            {
                if(x_2 - x_1)
                    y_2 = y_2 + (float)(x_min - x_1) * (float)(y_2 - y_1)/(x_2 - x_1);
                x_2 = x_min;
            }
            if(x_2 > x_max)
            {
                if(x_2 - x_1)
                    y_2 = y_2 + (float)(x_max - x_1) * (float)(y_2 - y_1)/(x_2 - x_1);
                x_2 = x_max;   
            }
            if(y_2 < y_min)
            {
                if(y_2 - y_1)
                    x_2 = x_2 + (float)(y_min - y_1) * (float)(x_2 - x_1)/(y_2 - y_1);
                y_2 = y_min;
            }
            if(y_2 > y_max)
            {
                if(y_2 - y_1)
                    x_2 = x_2 + (float)(y_max - y_1) * (float)(x_2 - x_1)/(y_2 - y_1);
                y_2 = y_max;   
            }
            printf("x2 = %d, y2 = %d\n", x_1, y_1);
        }
